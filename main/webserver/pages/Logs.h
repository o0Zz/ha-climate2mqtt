...
"    <pre id=\"logOutput\" style=\"white-space:pre; background:#111; color:#0f0; padding:12px; border-radius:6px; height:460px; overflow-y:auto; overflow-x:auto; font-size:12px;\"></pre>\n"
