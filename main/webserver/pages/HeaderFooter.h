...
"    button { background:#007bff; color:#fff; border:none; max-width:220px; padding:8px 12px; border-radius:4px; cursor:pointer; font-size: 1em; display:flex; align-items:center; justify-content:flex-start; gap:8px; text-align:left; }\n"
