...
"    .config-line { display: flex; align-items: baseline; gap: 8px; margin: 4px 0; }\n"
"    .config-label { font-weight: bold; color: #007bff; min-width: 200px; }\n"
...
"    .actions.actions-centered { align-items:center; }\n"
"    .actions.actions-centered > button { width:220px; }\n"
"    button { background:#007bff; color:#fff; border:none; max-width:220px; padding:8px 12px; border-radius:4px; cursor:pointer; font-size: 1em; display:flex; align-items:center; justify-content:flex-start; text-align:left; }\n"
